        ...
        <div className='py-8 border-b-2'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center py-8'>
                <div>
                    ...
                    <p className='text-5xl font-bold my-4'> {counterOn&&<CountUp start={0} end={50} duration={2} delay={0}/>}+</p>
                ...
                <div className='py-12 lg:py-0'>
                    ...
                    <p className='text-5xl font-bold my-4'>{counterOn&&<CountUp start={0} end={35} duration={0.8} delay={0}/>}M+</p>
                ...
                <div className='pb-12 lg:pb-0'>
                    ...
                    <p className='text-5xl font-bold my-4'>{counterOn&&<CountUp start={0} end={15} duration={0.5} delay={0}/>}+</p>
